...
- [x] 2.3 Document the reusable workflow entry point `lucinate-ai/concord/.github/workflows/concord.yml` as the one-caller-workflow adoption path
...
- [x] 3.1 Confirm the action paths, defaults, and the full-history requirement in the skill match `actions/*/action.yml`, `.github/workflows/concord.yml`, and the `github-actions` spec
